...
from storessales.logger import get_log_dataframe

STORESSALES_DATA_KEY = "storessales_data"
MEDIAN_STORESSALES_VALUE_KEY = "median_stores_value"

app = Flask(__name__)


@app.route('/artifact', defaults={'req_path': 'storessales'})
@app.route('/artifact/<path:req_path>')
def render_artifact_dir(req_path):
    os.makedirs("storessales", exist_ok=True)
...
def predict():
    context = {
       STORESSALES_DATA_KEY: None,
        MEDIAN_STORESSALES_VALUE_KEY: None
    }
